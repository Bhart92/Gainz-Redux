    ...
    <div className='container'>
        ...
        <div className='help--list-container'>
            <ol>
                ...
                <li>* * * * * If you select a new muscle group from the dropdown box to generate new workouts, or click the My Workouts link before SAVING WORKOUTS your list will not save, or update * * * * *</li>
